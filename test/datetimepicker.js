...
var el = document.getElementById('example-datepicker');
 
describe("DateTimePicker", function() {
  describe("constructor", function() {
    it("should have a date set by default equal to now", function() {
      var datetimepicker = new DateTimePicker(el);
    ...
    it("should set a date if one is provided", function() {
      var datetimepicker = new DateTimePicker(el, "Tuesday, 24 February 2015");
